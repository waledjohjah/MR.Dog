...
if (!$image_url) 
  $image_url = "images/upload/defultimage.jpg";
  ...
  if(isset($_POST['submit']))
  {
    ...
    $sql = "INSERT INTO dbShnkr22studWeb1.tbl_dog_207(dog_name, dog_birthday,dog_picture, dog_gender, dog_wieght, owner_id, dog_lost, dog_spayed)
          ...
          <form action="" method="GET">
            <div class='set'>
              ...
              <div class='set'>
                <div class='pets-breed'>
                  ...
                  <input type="text"  name="dog_picture" placeholder="Upload a photo..." value="<?php echo $dog_picture;?>" require >
                </div>
            ...
            <div class='set'>
              <div class='pets-breed'>
                ...
                <input id='pets-breed' name="breed" placeholder="dog breed" type='text' value="<?php echo $breed;?>" required>
              </div>
